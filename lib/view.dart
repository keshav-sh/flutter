      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text("System Engineer",textAlign: TextAlign.center,style: TextStyle(
                fontFamily: "SansBold",
                fontSize: 20,
                color: Colors.white,
                letterSpacing: 2,
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text("+977 9818154321",style: TextStyle(color: Colors.black,fontFamily: 'Sans'),),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text("keshav@gmail.com",style: TextStyle(color: Colors.black,fontFamily: 'Sans'),),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text("Mulapni",style: TextStyle(color: Colors.black,fontFamily: 'Sans'),),
              ),
            ),
            SizedBox(
              height: 10,
